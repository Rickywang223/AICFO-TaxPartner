...
const _agents = reactive([
  ...
  { id: 'agent-certify',    icon: '📄', name: '发票认证专员', status: 'warning', badge: '45%完成', summary: '还剩23张待认证', pendingCount: 23, lastActive: '11:30',  description: '专门负责发票认证的智能体',   style: 'concise',     capabilities: ['cap-py-certify', 'cap-py-invoice', 'cap-leq'],                knowledgeBases: ['kb-tax'],       model: 'Claude 4', temperature: 0.2, stats: { totalConversations: 67,  todayConversations: 5,  lastActiveAt: '2026-07-23T11:30:00' },
    dashTabs: { biDashboards: [{ id: 'db-1', name: '默认看板', type: 'bi' }], fixedTabs: [{ id: 'tasks', name: '任务管理', type: 'tasks' }, { id: 'capability', name: '能力管理', type: 'capability' }, { id: 'knowledge', name: '知识库', type: 'knowledge' }] } },
