...
export const capabilities = [
  // 🔌 MCP服务 - 票易通系列
  { id: 'cap-py-certify', name: '票易通发票认证',  category: 'mcp',    type: 'connection', status: 'enabled',  icon: '🔌', description: '票易通平台发票认证MCP服务',  endpoint: 'https://py-open.example.com/v1/certify',  lastActive: '今日 09:15', connectionStatus: 'connected', boundAgents: ['agent-certify'] },
  { id: 'cap-py-invoice', name: '票易通发票开票',  category: 'mcp',    type: 'connection', status: 'enabled',  icon: '🔌', description: '票易通平台发票开具MCP服务',  endpoint: 'https://py-open.example.com/v1/invoice',  lastActive: '今日 08:30', connectionStatus: 'connected', boundAgents: ['agent-certify'] },
  { id: 'cap-py-check',  name: '票易通发票查验',  category: 'mcp',    type: 'connection', status: 'enabled',  icon: '🔌', description: '票易通平台发票真伪查验MCP服务', endpoint: 'https://py-open.example.com/v1/verify',  lastActive: '昨日',       connectionStatus: 'connected', boundAgents: [] },
  { id: 'cap-py-recon',  name: '票易通数据对账',  category: 'mcp',    type: 'connection', status: 'disabled', icon: '🔌', description: '票易通平台进销项数据对账MCP服务',endpoint: 'https://py-open.example.com/v1/reconcile',lastActive: '3天前',      connectionStatus: 'disconnected', boundAgents: [] },
  // 🔌 MCP服务 - 通用
  ...
  // 🤖 大模型
  { id: 'cap-claude4',  name: 'Claude 4 Sonnet',  category: 'model',  type: 'model',     status: 'enabled',  icon: '🤖', description: 'Anthropic 旗舰模型，擅长复杂推理与长文本',      modelProvider: 'Anthropic', modelVersion: 'claude-sonnet-4-20250514',  temperature: 0.3,  maxTokens: 8192,  boundAgents: ['agent-assistant', 'agent-certify', 'agent-risk'] },
  { id: 'cap-claude3',  name: 'Claude 3.5 Haiku', category: 'model',  type: 'model',     status: 'enabled',  icon: '🤖', description: 'Anthropic 轻量模型，响应快速适合对话场景',      modelProvider: 'Anthropic', modelVersion: 'claude-3-5-haiku-20241022', temperature: 0.2,  maxTokens: 4096,  boundAgents: [] },
  { id: 'cap-gpt4o',    name: 'GPT-4o',       category: 'model',  type: 'model',     status: 'enabled',  icon: '🤖', description: 'OpenAI 多模态模型，支持图像理解与推理',          modelProvider: 'OpenAI',    modelVersion: 'gpt-4o-2025-07-01',    temperature: 0.2,  maxTokens: 16384, boundAgents: ['agent-declare'] },
  { id: 'cap-gpt4mini', name: 'GPT-4o Mini',  category: 'model',  type: 'model',     status: 'enabled',  icon: '🤖', description: 'OpenAI 高性价比模型，适合批量处理任务',          modelProvider: 'OpenAI',    modelVersion: 'gpt-4o-mini-2025-07-01',temperature: 0.1,  maxTokens: 8192,  boundAgents: [] },
  { id: 'cap-o1',       name: 'o1',           category: 'model',  type: 'model',     status: 'enabled',  icon: '🤖', description: 'OpenAI 推理模型，擅长数学与科学推理',           modelProvider: 'OpenAI',    modelVersion: 'o1-2025-07-01',         temperature: 0.1,  maxTokens: 32768, boundAgents: [] },
  { id: 'cap-qwen-max', name: '通义千问 Max', category: 'model',  type: 'model',     status: 'enabled',  icon: '🤖', description: '阿里云旗舰大模型，中文理解能力优秀',            modelProvider: '阿里云',    modelVersion: 'qwen-max-2026-06-01',   temperature: 0.3,  maxTokens: 8192,  boundAgents: [] },
  { id: 'cap-qwen-plus',name: '通义千问 Plus',category: 'model',  type: 'model',     status: 'disabled', icon: '🤖', description: '阿里云增强模型，平衡性能与成本',              modelProvider: '阿里云',    modelVersion: 'qwen-plus-2026-06-01',  temperature: 0.2,  maxTokens: 4096,  boundAgents: [] },
  { id: 'cap-deepseek', name: 'DeepSeek V4',  category: 'model',  type: 'model',     status: 'enabled',  icon: '🤖', description: 'DeepSeek 最新版本，MoE架构高性价比',             modelProvider: 'DeepSeek',  modelVersion: 'deepseek-v4-flash',      temperature: 0.2,  maxTokens: 8192,  boundAgents: [] },
  { id: 'cap-glm',      name: 'GLM-5',        category: 'model',  type: 'model',     status: 'disabled', icon: '🤖', description: '智谱AI 第五代GLM模型，工具调用能力强',          modelProvider: '智谱AI',   modelVersion: 'glm-5-2026-06-01',       temperature: 0.3,  maxTokens: 8192,  boundAgents: [] },
  { id: 'cap-ernie',    name: '文心一言 4.5', category: 'model',  type: 'model',     status: 'disabled', icon: '🤖', description: '百度文心大模型4.5，中文创作能力强',             modelProvider: '百度',     modelVersion: 'ernie-4.5-2026-06-01',   temperature: 0.3,  maxTokens: 4096,  boundAgents: [] },
...
export const managedAgents = [
  { id: 'agent-assistant',  icon: '👩‍💼', name: '杨姐的助理',   status: 'online',  description: '你的专属税务工作助手',     style: 'professional', capabilities: ['cap-leq', 'cap-king', 'cap-claude4'], knowledgeBases: ['kb-tax'],       model: 'Claude 4', temperature: 0.3, stats: { totalConversations: 120, todayConversations: 8, lastActiveAt: '2026-07-23T15:30:00' } },
  { id: 'agent-certify',    icon: '📄', name: '发票认证专员',  status: 'online',  description: '专门负责发票认证的智能体',   style: 'concise',     capabilities: ['cap-py-certify', 'cap-py-invoice', 'cap-leq'],                knowledgeBases: ['kb-tax'],       model: 'Claude 4', temperature: 0.2, stats: { totalConversations: 67,  todayConversations: 5,  lastActiveAt: '2026-07-23T11:30:00' } },
  { id: 'agent-risk',       icon: '⚠️', name: '风险预警官',    status: 'online',  description: '7×24小时监控企业税务风险',   style: 'data',        capabilities: ['cap-leq', 'cap-claude4'],                   knowledgeBases: [],               model: 'Claude 4', temperature: 0.1, stats: { totalConversations: 89,  todayConversations: 12, lastActiveAt: '2026-07-23T14:20:00' } },
